...
export const editableDesignContract = {
  shell: {
    ...
    section: 'mx-auto w-full max-w-[1760px] px-4 sm:px-6 lg:px-12',
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-extrabold leading-[1.02] tracking-tight sm:text-5xl lg:text-[4rem]',
    sectionTitle: 'text-xl font-extrabold tracking-[-0.03em] sm:text-2xl',
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-full ${editablePalette.darkBg} px-7 py-3 text-sm font-extrabold text-white transition hover:opacity-90`,
